const{isArray:A}=Array;const{defineProperty:b}=Object;$(document).ready(()=>{var C=', ';typeof skilljarUser!=='undefined'&&skilljarUser.firstName.length<=15&&skilljarUser.firstName.length>1?($('.first-name').html(skilljarUser.firstName+C),$('.first-name').css('display','inline-block'),$('.first-name').css('color','inherit'),$('.first-name').css('margin-right','5px')):($('.first-name').css('display','none'))});let B=document.createElement('style');B.textContent=`
...
.sj-page-catalog:not(.sj-page-catalog-root) #catalog-courses {
    margin-top: 40px;
    margin-bottom: 40px;
}`;document.head.append(B);let E=document.createElement('style');E.textContent=` 
...
.sj-page-detail .dp-curriculum>li {
    font-size: 16px;
}`;document.head.append(E);document.addEventListener('DOMContentLoaded',function(){var _a=document.querySelectorAll('.dp-curriculum > li:not(.section)');for(const D of _a){var _b=D.getAttribute('data-url')+'?reg=1',_c=document.createElement('a');_c.setAttribute('href',_b);while (D.firstChild)_c.appendChild(D.firstChild);D.appendChild(_c)}});let F=document.createElement('style');F.textContent=`
...
}`;document.head.append(F);let g=document.createElement('style');g.textContent=` 
...
}`;document.head.append(g);let H=document.createElement('style');H.textContent=` 
...
}`;document.head.append(H);let I=document.createElement('style');I.textContent=`
...
.socialaccount_providers {
    display: none !important;
}`;document.head.append(I);document.addEventListener('DOMContentLoaded',function(){var _A=document.querySelector('.sj-page-login');if(_A){var _B=document.querySelector('.sj-text-login-note'),_C=document.createElement('p');_C.classList.add('lp-sign-up-text');_C.innerHTML=`Need an account? <a href="${document.querySelector('.sj-text-sign-up').getAttribute('href')}">Sign up</a>`;_B.parentNode.insertBefore(_C,_B.nextSibling);document.querySelector('.sj-text-login-note').parentElement.style.width='100%';document.querySelector('.socialaccount_providers').parentElement.style.display='none'}var _d=document.querySelector('.sj-page-signup');if(_d){var _e=document.getElementById('login-content'),_f=document.querySelector('.sj-text-sign-in').getAttribute('href'),G=document.createElement('h1');G.classList.add('signup-custom-header');G.textContent='Sign up for Administrate University';var _h=document.createElement('p');_h.classList.add('signup-custom-link');_h.innerHTML=`Already have an account? <a href="${_f}">Sign in</a>`;_e.insertBefore(_h,_e.firstChild);_e.insertBefore(G,_h);document.querySelector('.signup').parentElement.style.width='100%';document.querySelector('.socialaccount_providers').parentElement.style.display='none'}});var J='left',N=document.createElement('div'),S=document.createElement('div'),{keys:_}=Object;document.addEventListener('DOMContentLoaded',function(){var aA=document.querySelectorAll('.coursebox-container');for(const aD of aA){var aB=aD.querySelector('.coursebox-text'),aC=aB.textContent.toLowerCase();aC.indexOf('[separator]')!==-1&&(aB.textContent=aB.textContent.replace('[separator]',''),aB.textContent=aB.textContent.replace('[Separator]',''),aD.style.textAlign=J)}});document.addEventListener('DOMContentLoaded',function(){var aE=document.querySelector('.sj-page-catalog-root');if(aE){var aF=document.querySelectorAll('a.coursebox-container[data-tags*="separator"]');for(const aG of aF)$('<section class=\'course-listing-section\'>').insertAfter($(aG).parent()).append($(aG).nextAll().addBack())}});let k=document.createElement('style');k.textContent=`
...
a.coursebox-container[data-tags*="separator"] .coursebox-callout {
    display: none !important;
}`;document.head.append(k);var L={'Learn':{'nestedLinks':{'All courses':{'href':'/page/course-catalog','target':'_self'},'Live training':{'href':'/calendar','target':'_self'}}},'Resources':{'nestedLinks':{'Release notes':{'href':'https://support.getadministrate.com/hc/en-us/categories/115001277127-Release-Notes','target':'_self'},'Support Portal':{'href':'https://support.getadministrate.com/hc/en-us','target':'_self'},'Developer Portal':{'href':'https://developer.getadministrate.com/','target':'_self'}}},'My courses':{'href':'/accounts/profile#profile-path-table','target':'_self'}};let M=document.createElement('style');M.textContent=` 
#header {
    background-color: #ffffff;
    border-bottom: 1px solid var(--gray-300);
...
</div>`;document.body.appendChild(N);let O=document.createElement('style');O.textContent=`
...
}`;document.head.append(O);document.addEventListener('DOMContentLoaded',function(){var aH=document.querySelector('.sj-page-catalog'),aI=document.querySelector('.sj-page-login'),aJ=document.querySelector('.sj-page-signup'),_D=document.querySelector('.sj-page-profile'),_E=document.getElementById('ep-footer'),_g=_F.getFullYear(),_H=document.querySelector('#ep-footer #footer-left ul li');var _F=new Date;_H&&$(_H).text(`©${_g} Administrate Limited. All rights reserved.`);if(aH||aI||aJ||_D){var _i=document.querySelector('.footer-background-wrapper');_i&&(_E.parentNode.insertBefore(_i,_E),_i.style.display='flex')}});let P=document.createElement('style');P.textContent=`
...
.tt1-image-section {
    border-radius: var(--border-radius);
    overflow: hidden; 
}`;document.head.append(P);document.addEventListener('DOMContentLoaded',function(){var aK=document.querySelectorAll('.sj-page-detail-path');if(aK.length>0){var aL=document.querySelectorAll('.course-overview__toggle');if(aL.length>0){for(var i=0;i<aL.length;i++)aL[i].style.pointerEvents='initial';var aM=document.querySelectorAll('a.course-overview__content__lesson');for(var j=0;j<aM.length;j++)aM[j].style.pointerEvents='none'}}});let q=document.createElement('style');q.textContent=` 
...
.sj-page-detail #skilljar-content .dp-row-flex-v2 {
    ...
    max-width: var(--max-width-lg);
}`;document.head.append(q);document.addEventListener('DOMContentLoaded',function(){var aN=$('.sj-page-path'),aO=$('.path-curriculum-button-wrapper');(aN&&aO)&&$('.tt1-text-section').append(aO.detach())});document.addEventListener('DOMContentLoaded',function(){var aP=$('.sj-page-curriculum');aP.length>0&&$('.sj-page-curriculum .tabs .course-long-description-header').parent().createElement('div').append($('.sj-course-time').detach())});var R=document.createElement('style');R.textContent=`
...
</div>`;document.body.appendChild(S);let T=document.createElement('style');T.textContent=`
...
}`;document.head.append(T);document.addEventListener('DOMContentLoaded',function(){var aQ=document.querySelector('.sj-page-catalog-root');if(aQ){var aR=document.getElementById('skilljar-content'),aS=document.querySelector('.catalog-lower-wrapper');aR.parentNode.insertBefore(aS,aR.nextSibling);aS.style.display='flex'}});$('document').ready(()=>$('[data-catalog-page="ilt-webinars"]').attr('href','/calendar'));$(document).ready(()=>{if($('.sj-page-lesson').length!=0&&$('.next-lesson-button').length==0){var aT='<div id="back-to-catalog"><a href="/" class="small button next-lesson-link"><span>Back to catalog</span></a></div>';$('.full-footer-height-wrapper.align-vertical').prepend(aT)}});$(document).ready(()=>$('#returnToOverview').detach().insertBefore('.course-title'));$(document).ready(()=>$('.sj-text-details-pane-summary').remove());let U=document.createElement('style');U.textContent=`
